...
CREATE VIEW market_board_view as
SELECT market_board.id         AS 'id',
       market_board.title      AS 'title',
       market_board.content    AS 'content',
       market_board.image_url  AS 'image_url',
       market_board.cost  AS 'cost',
       market_board.type  AS 'type',
       market_board.step  AS 'step',
       market_board.created_at AS 'created_at',
       market_board.updated_at AS 'updated_at',
       market_board.deleted_at AS 'deleted_at',
       market_board.user_id    AS 'user_id',
...
FROM market_board
         LEFT JOIN users ON market_board.user_id = users.id
